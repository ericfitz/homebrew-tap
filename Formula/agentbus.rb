...
class Agentbus < Formula
  ...
  url "https://github.com/ericfitz/agentbus/releases/download/v1.0.5/agentbus-v1.0.5-macos-universal.tar.gz"
  sha256 "024cd283c2ebe80130cdfd5b2a9276786f25262985e50fe5574cda6f853b80d4"
  license "Apache-2.0"
