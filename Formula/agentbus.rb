...
class Agentbus < Formula
  ...
  url "https://github.com/ericfitz/agentbus/releases/download/v0.11.0/agentbus-v0.11.0-macos-universal.tar.gz"
  sha256 "ce1025a98c59141cd844347943b3dc3bd380085a886c200243429bb775dd1bec"
  license "Apache-2.0"
