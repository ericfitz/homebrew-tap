...
class Agentbus < Formula
  ...
  url "https://github.com/ericfitz/agentbus/releases/download/v1.5.1/agentbus-v1.5.1-macos-universal.tar.gz"
  sha256 "01f525679857bf1b3ffe57747415a8b048ded3fcbb4068e4db10ec0984834e36"
  license "Apache-2.0"
